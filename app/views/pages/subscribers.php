            ...
            <div class="panel-body">
                <form role="form" method="POST" action="">
                    <div class="form-group">
                        <label>Subscriber Title</label>
                        <input class="form-control" name="category_title" placeholder="Enter title">
                    </div>
                    <div class="form-group">
                        <label>Subscriber Meta Title</label>
                        <input class="form-control" name="category_meta_title"
                            placeholder="Enter meta title">
                    </div>
                    <div class="form-group">
                        <label>Subscriber Path</label>
                        <input class="form-control" name="category_path" placeholder="Enter path">
                    </div>
                    <input type="hidden" name="form_name" value="create_category">
